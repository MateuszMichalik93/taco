...
insert into Ingredient(id, name, type) values ('FLT0', 'pszenna', 'WRAP');
...
insert into Ingredient(id, name, type) values ('JACK', 'Monterey', 'CHEESE');
insert into Ingredient(id, name, type) values ('SLSA', 'pikantny sos pomidorowy', 'SAUCE');
insert into Ingredient(id, name, type) values ('SRCR', 'pszenna', 'SAUCE');
